...
export default function Home() {
  ...
  const ViewArticle = async(nft) =>{
    ...
    // if balance <0.01 then alert can't view article
    console.log(balanceval)
  ...
  const ViewArticlenew = () =>{
    ...
    <div className="rounded overflow-hidden shadow-lg">
      ...
      <div className="px-6 pt-4 pb-2">
        ...
        <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#GTFOL!</span>
      </div>
    </div>
    </div>
    </div>
  ...
  if (loadingState === 'loaded' && !nfts.length) return (<h1 className="px-20 py-10 text-3xl">No articles to display currently</h1>)
  return (
  <div className="flex justify-center">
   <div className="flex justify-center">
  <DisplayArticle/>
